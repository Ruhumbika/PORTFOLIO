...
export const projects: Project[] = [
  {
    ...
    images: [
      ...
      { label: 'System workflow diagram', ratio: 'wide' },
    ],
  ...
  },
  {
    ...
    images: [
      { label: 'Chat interface', ratio: 'video' },
      { label: 'Architecture diagram', ratio: 'wide' },
      { label: 'API request flow', ratio: 'video' },
      { label: 'RAG workflow', ratio: 'video' },
      { label: 'Testing screenshot', ratio: 'video' },
    ],
    liveUrl: undefined,
    githubUrl: undefined,
    caseStudySections: [
  ...
  },
  {
    ...
    images: [
      ...
      { label: 'Mobile interface', ratio: 'portrait' },
      { label: 'Social-media branding', ratio: 'square' },
    ],
